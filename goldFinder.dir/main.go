...
func main() {
	...
	// // Gold18 :=
	// go httpGet("https://www.tgju.org/profile/geram18", "priceGold", responseChannel, wg)
	// // price.Gold18 = Gold18
	// wg.Add(1)

	// // GoldDast2 :=
	// go httpGet("https://www.tgju.org/profile/gold_mini_size", "priceGold", responseChannel, wg)
